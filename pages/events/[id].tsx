...
function Events() {
  ...
  console.log("datafromuseGetEventQuery", data);
  ...
  console.log("watch", data?.event?.vehicles);
                ...
                >
                  ...
                  <div className="flex-auto p-3 lg:space-y-4 sm:p-6">
                    ...
                    <div className="">
                      ...
                      >
                        <dl className="grid grid-cols-1 gap-x-4 gap-y-1 sm:gap-y-3 sm:grid-cols-3">
