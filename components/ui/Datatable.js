...
import { SearchIcon, SelectorIcon, SortAscendingIcon, SortDescendingIcon } from '@heroicons/react/outline';
                    ...
                    <table
                        ...
                        <thead className="bg-primary rounded-lg ">
                            {headerGroups.map((headerGroup, hgidx) => (
                                <tr key={hgidx} className="divide-x divide-gray-200" {...headerGroup.getHeaderGroupProps()}>
                                    {headerGroup.headers.map((column, colIdx) => (
                                        <th
                                            key={colIdx}
                                            {...column.getHeaderProps(column.getSortByToggleProps())}
                                            className="py-3.5 pl-2 pr-1 text-sm font-semibold text-gray-100 text-left sm:pl-6">
                        ...
                        return (
                            <div
                                ...
                                {row.cells.map((cell, cIdx) => {
                                    return (
                                        <div key={cIdx} {...cell.getCellProps()} className={rowClass}>
                                            {cell.render('Cell')}
                                        </div>
                                    );
                                })}
